...
socket& socket::operator=(socket&& another) {
...
bool socket::nonblock() const {
    return (::fcntl(_raw, F_GETFL) & O_NONBLOCK) != 0;
}
void socket::set_nonblock(bool v) {
...
bool socket::bind(address const& addr) {
